...
THREE.Matrix4.prototype = {
	...
	lookAt: function ( eye, center, up ) {
		...
		//先相减 在单位化 注意：eye-center保证了是右手坐标系
	...
	//两个矩阵相乘，将结果存入r数组 还把当前矩阵给改了，注意：列主序的数组
	...
	//3*3矩阵乘以3维向量 本质上确实是旋转轴，这个向量 现在定义在了矩阵的列空间下
	...
	//计算行列式 线性代数最丑的就是行列式 既慢有难懂，高斯消元会更好
	...
	//根据偏移值 将当前矩阵的数据 放入 flat数组中 可以是为了统一传入gpu
	...
	//获得矩阵的逆矩阵，这些都是线性代数中最简单的内容，然而，考研后，看见就头大
	//我以前实现过高斯消元来进行求逆矩阵，印象中那个算法既优雅又高效，而下面的这段代码
	//既丑陋又搞笑。
